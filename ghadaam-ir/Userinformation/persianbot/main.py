...
class ChatBot:
    ...
    def get_response(self, user_input):
        ...
        return self.databasecli[best_match] if highest_prob >= 0.5 else "ببخشید معذرت می خوام در خواستی را که از من خواستید نمی توانم جواب بدهم"
...
def send_message(event=None):
    ...
    message_text.insert(tk.END, "user: " + user_input + "\n")
...
send_button = ttk.Button(input_frame, text='ارسال', command=send_message, style='TButton')
